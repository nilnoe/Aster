...
final class MetalView: MTKView {
  ...
  /// 上次测量——滚动事件不再与渲染帧对同一批行重复 shaping。internal：
  /// MetalView+Viewport 跨文件扩展访问（模块边界内封装）。
  var measuredWidthKey: (version: Int, firstLine: Int, lastLine: Int)?
  var measuredWidthValue: CGFloat = 0
