...
| ADR-023 | 保存语义：SQLite 自动保存（v1.2：日期+序号轮转，单日多快照文件；默认目录可指定；磁盘写回 Deferred） | Accepted | 2026-08-02 | Store 2 方法 + 1 错误变体 + Bridge FFI 4 项（v1.2） | core（store、bridge）、app、docs | [ADR-023-disk-save.md](ADR-023-disk-save.md) |
