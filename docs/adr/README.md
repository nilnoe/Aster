...
| ADR-013 | SQLite 存储层（Store）（v1.2：崩溃恢复原语 + 角色边界与保留论证） | Accepted | 2026-08-02 | 2 类型 + 10 方法 + 1 变体 | Core（store 模块）、app（恢复流程） | [ADR-013-sqlite-store.md](ADR-013-sqlite-store.md) |
