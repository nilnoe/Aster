...
| ADR-021 | 性能基准体系（criterion）（v1.2：CI 粗告警阈值 100% / 下限 100µs） | Accepted | 2026-08-02 | 0（dev-only） | core（benches）、docs/benchmarks.md、.github/workflows/ci-bench.yml、bench-baseline/ | [ADR-021-performance-benchmarks.md](ADR-021-performance-benchmarks.md) |
