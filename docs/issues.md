...
| I-002 | P1 | 编辑器没有保存能力：关窗即丢编辑；Roadmap 无保存切片 | 全仓无持久化路径；T-015 只有 open | T-037 → T-040 → T-041 → T-042（ADR-023 v1.4：Cmd+N 纯文本快照 / 自动保存缓冲 / Cmd+S 合并） | Fixed | 135f44a + d28cb9b + c4b4710 + 本切片（T-042） |
